...
class PlayerDBManager(BaseManager):
    ...
    def _calculate_player_stats(
        ...
        new_stats = {
            ...
            "unbeaten_streak": player.unbeaten_streak,  # Add this line
        ...
        if tied:
            ...
            new_stats["unbeaten_streak"] = player.unbeaten_streak + 1
        elif won:
        ...
        new_stats["best_unbeaten_streak"] = max(
            player.best_unbeaten_streak, new_stats["unbeaten_streak"]
        )
        return new_stats
